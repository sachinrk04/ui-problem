    ...
    <div className="sidebar">
      <ul className="side-page-nav_items">
        <li className={`side-page-nav_item`}>
          <Link to="/make-sidebar">Make SideBar</Link>
        </li>
        <li className={`side-page-nav_item`}>
        ...
        <li className={`side-page-nav_item`}>
          <Link to="/counter-context-api">Counter ContextApi</Link>
        </li>
        <li className={`side-page-nav_item`}>
        ...
        <li className={`side-page-nav_item`}>
          <Link to="/drag-and-drop-notes">Drag & Drop Notes</Link>
        </li>
        <li className={`side-page-nav_item`}>
        ...
        <li className={`side-page-nav_item`}>
          <Link to="/common-table">Common Table</Link>
        </li>
        <li className={`side-page-nav_item`}>
        ...
        <li className={`side-page-nav_item`}>
          <Link to="/trello-board">Trello Board</Link>
        </li>
        <li className={`side-page-nav_item`}>
        ...
        <li className={`side-page-nav_item`}>
          <Link to="/nested-box">Nested Box</Link>
        </li>
        <li className={`side-page-nav_item`}>
